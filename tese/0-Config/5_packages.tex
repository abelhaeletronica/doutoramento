...
% Open Sans for headings only (main text stays newpx/palatino)
\usepackage[defaultsans,scale=0.95]{opensans}
\renewcommand*{\printchaptertitle}[1]{%
  {\raggedleft\sffamily\huge\bfseries #1\par}\nobreak%
}
\makeatletter
\xpatchcmd{\chs@ell@helper}{\chapnumfont\normalfont}{\chapnumfont\sffamily}{}{}
\xpatchcmd{\chs@ell@helper}{\chapnumfont\normalfont}{\chapnumfont\sffamily}{}{}
\makeatother
...
% Open Sans for the table of contents and list of figures
...
% Open Sans for running headers
\makeheadrule{novathesis@mainmatter}{0pt}{0pt}
\makeevenhead{novathesis@mainmatter}{\small\sffamily\leftmark}{}{}
\makeoddhead{novathesis@mainmatter}{}{}{\small\sffamily\rightorleftmark}
